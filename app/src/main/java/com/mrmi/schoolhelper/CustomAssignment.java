...
public class CustomAssignment
{
    ...
    @SerializedName("Date Due String")
    ...
    public String calculateRemainingTime()
    {
        ...
        String[] items1 = dateDueString.split("/"); //Split the dateDueString into 3 parts (month, day, year)
        ...
        return (((dueDateCalendar.getTimeInMillis()-currentDate.getTimeInMillis())/86400000) + " DAYS");
    }
}
